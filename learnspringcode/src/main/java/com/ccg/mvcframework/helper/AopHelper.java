...
import com.ccg.mvcframework.aop.proxy.AspectProxy;
import com.ccg.mvcframework.aop.proxy.Proxy;
import com.ccg.mvcframework.aop.proxy.ProxyFactory;
import com.ccg.mvcframework.aop.proxy.impl.TransactionProxy;
...
public final class AopHelper {
    ...
    static {
        try {
            //切面类-目标类集合的映射：key--TransactionProxy或者切面
    ...
    private static Set<Class<?>> createTargetClassSet(Aspect aspect) throws Exception {
        ...
        if (!pkg.equals("") && !cls.equals("")) {
            ...
            targetClassSet.addAll(ClassLoaderUtil.getClassSet(pkg));
        }
